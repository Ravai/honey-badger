<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.master" AutoEventWireup="true" CodeFile="Home2.aspx.cs" Inherits="Home" %>
...
<script language="javascript">
   function PopupPicker(ctl,w,h)
   {
    ...
    <tr>
        ...
        <asp:Table runat="server" Width="100%" ID="tbl_UpcomingTaskList" Height="300px" />
        <div style="float:right;">
            <asp:LinkButton runat="server" ID="btn_gotoUpcoming" PostBackUrl="~/ViewUpcoming.aspx" Font-Bold="true" Font-Size="Large" Text="View All Upcoming" Visible="false" />
        </div>
        </div>
        ...
        <asp:Table runat="server" Width="100%" ID="tbl_ReadyTaskList" Height="300px" />
        <div style="float:right;">
            <asp:LinkButton runat="server" ID="btn_gotoReady" PostBackUrl="~/ViewReady.aspx" Font-Bold="true" Font-Size="Large" Text="View All Ready" Visible="false" />
        </div>
        </div>
        ...
        <div style="font-size:Medium; font-weight:bold;">Tasks in Progress</div> <i>(Task has been started)</i><br />
        <asp:Table runat="server" Width="100%" ID="tbl_WipTaskList" Height="300px" />
        <div style="float:right;">
            <asp:LinkButton runat="server" ID="btn_gotoWip" PostBackUrl="~/ViewWip.aspx" Font-Bold="true" Font-Size="Large" Text="View All Wip" Visible="false" />
        </div>
        </div>
