...
public partial class Threads : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (DT.Rows.Count == 1)
        {
            ...
            {
                DataTable DT2 = theCake.getUserProjectPermissions(theCake.getUserID(theCake.getActiveUserName(Request.UserHostAddress)), Int32.Parse(projectID));
                if (DT2.Rows.Count == 1)
                {
    ...
    protected void btn_newPost_OnClick(object sender, EventArgs e)
    {
        ...
        theCake.addNewPost(Int32.Parse(Request.QueryString["ID"].ToString()), newPost, theCake.getUserID(theCake.getActiveUserName(Request.UserHostAddress)));
